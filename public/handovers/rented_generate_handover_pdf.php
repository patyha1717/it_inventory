...
function generateRentedHandoverPDF($employee, $assets)
{
    /* TEMP DIR */
    $tempDir = __DIR__ . "/tmp_rented";
    ...
    $mpdf->SetWatermarkText("Company IT Solutions", 0.05);
    ...
    <div style='font-family:sans-serif; margin:0px 10px; height: 180px;'>
        ...
        <h2 style='text-align:center; margin:5px 0 0;'>Company IT Solutions</h2>
        <h3 style='text-align:center; margin:0 0 8px;'>RENTED ASSET HAND OVER FORM</h3>
        <table width='100%' style='font-size:12px;'>
            <tr>
                <td>
                    <b>Registered Office Address:</b> Company IT Solutions<br>
                    Plot 228, above Bank of India, Zone-I,<br> MP Nagar, Bhopal 462001
                </td>
    ...
    <div style='padding-top:8px; margin:0px 10px; font-family:sans-serif; font-size:11px;'>
        ...
        <p style='text-align:justify; line-height:1.4; margin:0;'>
            ...
            I understand that these assets belong to Company IT Solutions Pvt Ltd and are under my
    ...
    $folder = __DIR__ . "/generated_rented";
    if (!file_exists($folder)) {
        mkdir($folder, 0777, true);
    }

    $file = $folder . "/rented_handover_" . time() . ".pdf";
    $mpdf->Output($file, 'F');
